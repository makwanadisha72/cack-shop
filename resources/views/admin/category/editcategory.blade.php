              ...
              <form action="{{route('category.update',$category)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" value="{{$category->name}}" class="form-control" name="name" id="exampleInputEmail1" placeholder="Enter name">
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Description</label>
                        <textarea name="description" id="" class="form-control" placeholder="Description">{{$category->name}}</textarea>
                        <span class="text-danger">
                            {{-- @error('description')
                                {{$message}}
                            @enderror --}}
                  ...
                  <div class="form-group">
                    Old image: <br>
                        <img src="/image/category/{{$category->image}}" width="150px" alt="">
                  </div>
                    <div class="form-group">
