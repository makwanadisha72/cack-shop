...
<div class="content-wrapper">
  ...
  <div class="card">
    <div class="card-header">
      ...
      <a href="{{route('products.create')}}" class="btn btn-primary float-right">ADD NEW</a>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
          ...
          <tr>
            <td>{{$value->id}}</td>
            <td><img src="../../image/products/{{$value->image}}" width="200px" alt=""></td>
            <td>{{$value->name}}</td>
            <td>{{$value->cat_name}}</td>
            <td>{{$value->subcat_name}}</td>
            <td>{{$value->description}}</td>
            <td>{{$value->price}}</td>
            <td><a href="{{route('products.edit',$value->id)}}"><i class="nav-icon fas fa-edit"></i></a></td>              
